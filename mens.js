...
document.querySelector("#filter").addEventListener("change",handleFilter);
    ...
    function handleFilter(){
      ...
      if(selected=="all"){
        ...
        let filterList=mensLs.filter(function(elem){
...
document.querySelector("h1").innerText="Mens page";
...
function displayPage(mensLs){
  document.querySelector("#container").innerHTML="";
  mensLs.forEach(function(elem){
    ...
    price_div.append(strprice,price,percentage)

    

    

    box.append(proImg,name,price_div,btn);
...
function addToCart(elem){
      ...
      localStorage.setItem("addTCart",JSON.stringify(addCartArr));
      alert("added to cart")
